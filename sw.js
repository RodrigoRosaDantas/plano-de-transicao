const CACHE='plano-transicao-v2';
const ASSETS=['./','./index.html','./assets/styles.css','./assets/app.js','./data/snapshot.json','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
