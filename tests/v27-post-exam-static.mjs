...
for (const asset of ['assets/post-exam-v27.css?v=27', 'assets/post-exam-v27.js?v=29']) has(index, asset, 'loader v27/v29');
...
assert.ok(index.indexOf('post-exam-v27.js?v=29') > index.indexOf('workspace-v23.js?v=29'), 'JS v27 deve carregar depois do workspace');
...
assert.ok(sw.includes("const CACHE='plano-transicao-v29-separate-phases'"), 'cache PWA precisa usar as fases separadas v29');
