...
expect('cache v39 inclui estilos das fases e tratamento móvel', serviceWorker.includes("plano-transicao-v39-pre-edital") && serviceWorker.includes("'./assets/transition-pages-v29.css'") && serviceWorker.includes("'./assets/pre-post-v33.css'") && serviceWorker.includes("'./assets/navigation-mobile-v38.css'"));
