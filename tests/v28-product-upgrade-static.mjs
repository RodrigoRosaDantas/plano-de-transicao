...
expect('cache v37 inclui estilos das fases e navegação móvel', serviceWorker.includes("plano-transicao-v37-pre-edital") && serviceWorker.includes("'./assets/transition-pages-v29.css'") && serviceWorker.includes("'./assets/pre-post-v33.css'") && serviceWorker.includes("'./assets/navigation-mobile-v37.css'"));
