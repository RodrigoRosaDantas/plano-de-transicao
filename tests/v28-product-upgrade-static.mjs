...
expect('cache v40 inclui estilos das fases, Radar Oficial e tratamento móvel', serviceWorker.includes("plano-transicao-v43-private-identifiers") && serviceWorker.includes("'./assets/transition-pages-v29.css'") && serviceWorker.includes("'./assets/pre-post-v33.css'") && serviceWorker.includes("'./assets/navigation-mobile-v38.css'"));
