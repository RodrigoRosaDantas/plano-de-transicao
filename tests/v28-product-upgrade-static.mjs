...
expect('cache v35 inclui estilos das fases e radar', serviceWorker.includes("plano-transicao-v35-pre-edital") && serviceWorker.includes("'./assets/transition-pages-v29.css'") && serviceWorker.includes("'./assets/pre-post-v33.css'"));
