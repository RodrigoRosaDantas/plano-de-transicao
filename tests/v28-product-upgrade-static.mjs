...
expect('v28 não re-renderiza o painel em loop', followUp.includes('const followUpSignature =') && (followUp.match(/const signature = followUpSignature\\(data\\);/g) || []).length === 2);
