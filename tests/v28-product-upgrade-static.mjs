...
expect('cache v51 inclui estilos das fases, Radar Oficial e tratamento móvel', serviceWorker.includes("plano-transicao-v51-seedf-preedital-web") && serviceWorker.includes("'./assets/transition-pages-v29.css'") && serviceWorker.includes("'./assets/pre-post-v33.css'") && serviceWorker.includes("'./assets/navigation-mobile-v38.css'"));
