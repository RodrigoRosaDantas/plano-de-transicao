...
assert(sw.includes("plano-transicao-v52-history-reconciliation")&&sw.includes("post-exam-quadrix-v44.js"),"service worker recarrega o painel privado no cache v52 do PWA");
...
assert(sw.includes("plano-transicao-v52-history-reconciliation")&&sw.includes("post-exam-quadrix-v44.js"),"PWA inclui monitor Quadrix no cache v52");
