...
assert.ok(index.includes('__PLANO_UI_RELEASE__ = "v37"'));
assert.ok(index.includes('work-app.js?v=37&home=37'));
assert.ok(sw.includes("const CACHE='plano-transicao-v37-pre-edital'"));
