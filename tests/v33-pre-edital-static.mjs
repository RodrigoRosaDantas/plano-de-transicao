...
assert.ok(index.includes('__PLANO_UI_RELEASE__ = "v39"'));
assert.ok(index.includes('work-app.js?v=39&home=37'));
assert.ok(sw.includes("const CACHE='plano-transicao-v39-pre-edital'"));
