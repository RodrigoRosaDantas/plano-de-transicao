...
assert.ok(index.includes('__PLANO_UI_RELEASE__ = "v36"'));
assert.ok(index.includes('work-app.js?v=36&home=37'));
assert.ok(sw.includes("const CACHE='plano-transicao-v36-pre-edital'"));
