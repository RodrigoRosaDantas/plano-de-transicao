...
assert.ok(index.indexOf('exam-day-v21-bootstrap.js?v=31') < index.indexOf('assets/work-app.css?v=36'), 'bootstrap precisa nascer no head antes do app-base');
...
has(sw, "const CACHE='plano-transicao-v52-history-reconciliation'", 'cache consolidado v52');
