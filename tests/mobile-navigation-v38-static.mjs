...
assert.match(sw, /plano-transicao-v39-pre-edital/, 'Service worker deve invalidar o cache anterior');
...
console.log('PASS  v39: barra inferior removida, espaço inferior limpo e navegação superior preservada.');
