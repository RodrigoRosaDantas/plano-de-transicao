...
assert.match(index, /__PLANO_UI_RELEASE__ = "v38"/, 'HTML deve declarar o release v38');
...
assert.match(sw, /plano-transicao-v38-pre-edital/, 'Service worker deve invalidar o cache anterior');
