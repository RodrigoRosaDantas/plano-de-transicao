...
assert.match(index, /__PLANO_UI_RELEASE__ = "v40"/, 'HTML deve declarar o release v40');
...
assert.match(sw, /plano-transicao-v43-private-identifiers/, 'Service worker deve usar o cache vigente do Radar Oficial');
