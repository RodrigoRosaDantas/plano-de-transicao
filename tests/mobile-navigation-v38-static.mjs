...
assert.match(index, /__PLANO_UI_RELEASE__ = "v44"/, 'HTML deve declarar o release v40');
...
assert.match(sw, /plano-transicao-v44-sedes-quadrix/, 'Service worker deve usar o cache vigente do Radar Oficial');
