...
check('service worker está no cache v51 da identidade da Central e Radar pré-edital', sw.includes("const CACHE='plano-transicao-v51-seedf-preedital-web'") && sw.includes("'./radar-oficial.html'"));
