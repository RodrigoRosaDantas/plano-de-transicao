...
check('service worker está no cache v52 de reconciliação do histórico', sw.includes("const CACHE='plano-transicao-v52-history-reconciliation'") && sw.includes("'./radar-oficial.html'"));
