...
check('Cache PWA está consolidado na v34', sw.includes("const CACHE='plano-transicao-v34-pre-edital'"));
check('Cache busting da interface publicada está em v34', index.includes('__PLANO_UI_RELEASE__ = "v34"') && index.includes('work-app.js?v=34&home=37') && index.includes('transition-pages-v29.css?v=34') && index.includes('pre-post-v33.css?v=34'));
...
check('Estilos das fases estão publicados', index.includes('transition-pages-v29.css?v=34') && index.includes('pre-post-v33.css?v=34') && pageStyles.includes('.preexam-hero') && pageStyles.includes('.post-exam-view'));
