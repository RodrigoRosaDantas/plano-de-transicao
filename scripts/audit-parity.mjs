...
check('Cache PWA está consolidado na v30', sw.includes("const CACHE='plano-transicao-v30-separate-phases'"));
...
check('Pós-prova liga o painel de acompanhamento', index.includes('assets/post-exam-follow-up-v28.js?v=30') && followUp.includes('ACOMPANHAMENTO PÓS-PROVA'));
...
check('Estilos das fases estão publicados', index.includes('transition-pages-v29.css?v=30') && pageStyles.includes('.preexam-hero') && pageStyles.includes('.post-exam-view'));
