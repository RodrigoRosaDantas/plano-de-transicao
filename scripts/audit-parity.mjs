...
check('Cache PWA está consolidado na v42', sw.includes("const CACHE='plano-transicao-v42-personal-web-radar'") && sw.includes("'./radar-oficial.html'") && sw.includes("'./assets/official-monitor.css'") && sw.includes("'./assets/official-monitor.js'"));
