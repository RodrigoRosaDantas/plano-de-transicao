...
check('Cache PWA está consolidado na v35', sw.includes("const CACHE='plano-transicao-v35-pre-edital'"));
check('Cache busting da interface publicada está em v35', index.includes('__PLANO_UI_RELEASE__ = "v35"') && index.includes('work-app.js?v=35&home=37') && index.includes('transition-pages-v29.css?v=35') && index.includes('pre-post-v33.css?v=35'));
...
check('Estilos das fases estão publicados', index.includes('transition-pages-v29.css?v=35') && index.includes('pre-post-v33.css?v=35') && pageStyles.includes('.preexam-hero') && pageStyles.includes('.post-exam-view'));
